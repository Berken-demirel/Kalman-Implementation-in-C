...
void __declspec(dllexport) my_kalman(int measured_x, int measured_y)
{
	...
	for (int i = 0; i < 1; i++)
	{
		...
		result[1][0] = -(coeff*result[1][0]); result[1][1] = coeff * result[1][1];
		...
		// I - KH
		double result2[4][4];
		result2[0][0] = 1 - K_cross_H[0][0]; result2[0][1] = -K_cross_H[0][1]; result2[0][2] = -K_cross_H[0][2]; result2[0][3] = -K_cross_H[0][3];
		result2[1][0] = -K_cross_H[1][0]; result2[1][1] = 1 - K_cross_H[1][1]; result2[1][2] = -K_cross_H[1][2]; result2[1][3] = -K_cross_H[1][3];
		result2[2][0] = -K_cross_H[2][0]; result2[2][1] = -K_cross_H[2][1]; result2[2][2] = 1 - K_cross_H[2][2]; result2[2][3] = -K_cross_H[2][3];
		result2[3][0] = -K_cross_H[3][0]; result2[3][1] = -K_cross_H[3][1]; result2[3][2] = -K_cross_H[3][2]; result2[3][3] = 1 - K_cross_H[3][3];
		// (I-kH)* Ppred
		for (int i = 0; i < 4; i++)
		{
			for (int j = 0; j < 4;j++)
